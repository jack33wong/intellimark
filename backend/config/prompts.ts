       ...
       **Annotation Rules:**
        ...
        - **CRITICAL - Drawing/Graph Page Index Detection:**
          ...
          * **EXAMPLE:**
            ...
            - **Correct pageIndex: 2** (the grid page)
            - **Wrong pageIndex: 1** (the question text page)
          * **VERIFICATION:** Double-check by examining the image - does this page have the actual grid/diagram space?
