...
async function forensicAudit().then(() => process.exit()) {
    console.log('🔍 Forensic Audit: AQA November 2024 8300/1F');
    try {
        ...
        snapshot.forEach(doc => {
            ...
            questions.forEach(q => {
                ...
                subQuestions.forEach(sq => {
                    ...
                    console.log(`    - Checking Part ${sqNum} - RAW: ${JSON.stringify(sq)}...`);
...
forensicAudit().then(() => process.exit());
