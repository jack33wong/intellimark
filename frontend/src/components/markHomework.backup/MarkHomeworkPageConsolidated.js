...
const MarkHomeworkPageConsolidated = ({
  ...
  const handleModelChange = useCallback((model) => {
    console.log('🔍 MarkHomeworkPageConsolidated - handleModelChange called with:', model);
  ...
  console.log('🔍 MarkHomeworkPageConsolidated - About to render MainLayout with props:', {
    selectedModel,
