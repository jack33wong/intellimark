...
try {
  ...
  // Initialize Analytics - Production Only Check
  if (typeof window !== 'undefined' &&
    process.env.NODE_ENV === 'production' &&
    (process.env.REACT_APP_FIREBASE_MEASUREMENT_ID || (firebaseConfig as any).measurementId)) {

    // Only initialize analytics on client side in production
