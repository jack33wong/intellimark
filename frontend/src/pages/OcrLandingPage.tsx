        ...
        <div className="light-mode-forced ocr-landing-page">
            ...
            <section className="landing-section ocr-hero-section">
                <div className={`ocr-hero-content ${startAnimations ? 'trigger-anim' : ''}`}>
                    <h1 className="ocr-hero-title">Instantly Mark Your <span className="ocr-highlight-green">OCR</span> Maths Paper</h1>
                    <p className="ocr-hero-subtitle">Stop staring at confusing OCR mark schemes. Scan your handwritten 2020-2024 past papers and let our AI instantly grade your work like a real examiner. Supports OCR J560 Higher & Foundation.</p>
                    
                    <div className="hero-cta-group">
                        <div className="anim-item">
                            <button className="hero-primary-cta" onClick={() => navigate('/app?action=scan')}>
                                <span>Scan Your OCR Paper</span>
